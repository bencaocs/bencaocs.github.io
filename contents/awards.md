...
- Invited as ~20 SCI journals reviewer, such as IEEE Transactions on Neural Networks and Learning, IEEE Transactions on Nanobioscience, IEEE Transactions on Molecular Biological and Multi-Scale Communications, Advanced Science, Briefings in Bioinformatics, Computational and Structural Biotechnology Journal, Future Generation Computer Systems, Scientific Reports, IEEE Communications Letters, Peerj, BMC bioinformatics, Peerj computer science et al.
...
------
- Yanfen Zheng, DNA coding and Error correction, Published 2 SCI Paper (IEEE TCBB and FIG), Currently pursuing a Phd student at DLUT.
- Penghao Wang, DNA cluster, Published 2 SCI Paper (CIBM and FIBB), Currently pursuing a Phd student at TJU.
- Lijun Sun, DNA Triplex design, Published 1 SCI Paper (JPCB), Currently pursuing a Phd student at DLUT.
- Ziniu Mu, DNA storage coding, Published 1 SCI Paper (IEEE TNB).
